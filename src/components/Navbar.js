...
const CustomLink = ({href, title, className=""}) => {
    ...
    return (
        <Link href={href} className={`${className} relative group`}>
            ...
            absolute left-0 -bottom-0.5 group-hover:w-full transition-[width] ease 
            duration-300
...
const NavBar = () => {
    ...
    return (
        ...
        dark:text-light relative z-10 lg:px-16 md:px-12 sm:px-8'>
            ...
            left-1/2 -translate-x-1/2 -translate-y-1/2 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md
            py-32'>
